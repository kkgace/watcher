...
!function (t) {
    ...
    e.prototype = {
        ...
        switch (i) {
            ...
            case"submit":
                ...
                return t.isEmptyObject(c) ? (s = this.editable("getValue"), a.data && t.extend(s, a.data), t.ajax(t.extend({
                    url: a.url,
                    data: s,
                    type: "POST"
                }, a.ajaxOptions)).success(function (t) {
    ...
    t.fn.editableutils.inherit(e, t.fn.editabletypes.abstractinput), t.extend(e.prototype, {
        render: function () {
            ...
            if (t.isArray(e)) {
                ...
                for (var a = 0; a < e.length; a++)o = e[a], "object" == typeof o ? (i = 0, t.each(o, r), 1 === i ? s.push(n) : i > 1 && (o.children && (o.children = this.makeArray(o.children)), s.push(o))) : s.push({
                    value: o,
                    text: o
                })
        ...
        constructor: e, init: function () {
            ...
            function i(e, i) {
                ...
                return e.children("option").each(function (e, o) {
                    ...
                    "" !== s && (r = Math.abs(s - i), ("undefined" == typeof n.distance || r < n.distance) && (n = {
                        value: s,
                        distance: r
                    }))
                }), n.value
        ...
        setPosition: function () {
            !function () {
                ...
                switch (r = "function" == typeof this.options.placement ? this.options.placement.call(this, d[0], this.$element[0]) : this.options.placement, e = /in/.test(r), d.removeClass("top right bottom left").css({
                    ...
                    left: 0,
                    display: "block"
                }), i = this.getPosition(e), n = d[0].offsetWidth, o = d[0].offsetHeight, r = e ? r.split(" ")[1] : r, l = {
                    top: i.top + i.height,
                    left: i.left + i.width / 2 - n / 2
                }, a = {top: i.top - o, left: i.left + i.width / 2 - n / 2}, c = {
                    top: i.top + i.height / 2 - o / 2,
                    left: i.left - n
                }, h = {top: i.top + i.height / 2 - o / 2, left: i.left + i.width}, r) {
                    case"bottom":
    ...
    var h = t.fn.datepicker.dates = {
        ...
        parseDate: function (i, n, r) {
            ...
            var p, f, s, c = i && i.match(this.nonpunctuation) || [], i = new Date, g = {}, m = ["yyyy", "yy", "M", "MM", "m", "mm", "d", "dd"], v = {
                yyyy: function (t, e) {
